class Face {
  ...
  void drawFace( float alpha, boolean myFace) {
    if ( bHasFace ) {
      ...
      stroke(50);
      strokeWeight(2);
      arc(leftEye.x, leftEye.y, 40, 20, radians(180), radians(360), OPEN);
      ...
      stroke(0);
      strokeWeight(2);
      arc(rightEye.x, rightEye.y, 40, 20, radians(180), radians(360), OPEN);
      
      if ( !myFace ){
        line( leftEye.x + 20, leftEye.y, leftEye.x - 20, leftEye.y-20);
        line( rightEye.x - 20, rightEye.y, rightEye.x + 20, rightEye.y-20);
      }
